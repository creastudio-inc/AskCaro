    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        QuestionModel_QuestionId = c.Guid(),
                    })
                .PrimaryKey(t => t.AnswerId)
                .ForeignKey("dbo.Question", t => t.QuestionModel_QuestionId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ConversationsId = c.Guid(nullable: false),
                        Question = c.String(),
                        HtmlAnswers = c.String(),
                        CreaDate = c.DateTime(nullable: false),
                        Categories_categorieId = c.Guid(),
                    })
                .PrimaryKey(t => t.ConversationsId)
